...
#### Palette — Option A: "Deep Ocean" *(recommended)*
...
```css
/* CSS Breakpoints */
@media (max-width: 1366px) { /* xl → lg */ }
@media (max-width: 1280px) { /* lg → md */ }
@media (max-width: 992px)  { /* md → sm */ }
...
*DevLog Brandbook © 2025 — Internal Document*
